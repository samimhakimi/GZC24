...
const AddNewDeviceScreeen = ({navigation}) => {
  useEffect(() => {
  ...
  const addNow = async () => {
    ...
    await axios
      .post('https://www.gzc24.com/api-mobi/device/add', deviceData)
      .then(res => {
          ...
          <View>
            ...
            <TouchableOpacity style={styles.addNewDevice} onPress={addNow}>
              <Text style={styles.addNewDeviceText}>
                <FontAwesome name="plus-circle" size={18} /> Add Now
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
...
export default AddNewDeviceScreeen;
